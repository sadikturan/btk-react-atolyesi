        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center">
            ...
            >
              ...
              <span className="hidden sm:flex">Sepetim</span>
            </Link>
            ...
            {isAuthenticated ? (
              <>
                ...
                >
                  ...
                  <span className="hidden sm:flex">Siparişler</span>
                </Link>
                ...
                >
                  ...
                  <span className="hidden sm:flex">Çıkış</span>
                </button>
              </>
            ) : (
              <>
                ...
                >
                  ...
                  <span className="hidden sm:flex">Giriş</span>
                </Link>
              </>
            )}
