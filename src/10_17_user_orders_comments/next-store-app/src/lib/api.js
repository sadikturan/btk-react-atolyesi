...
export const get_admin_products = async (params = {}) => {
...
export const get_product_images = async (productId) => {
  const res = await api.get(`/products/admin/${productId}/images`);
  return res.data;
};

export const upload_product_image = async (productId, formData) => {
...
export const delete_admin_product_image = async (imageId) => {
  const res = await api.delete(`/products/admin/product-images/${imageId}`);
  return res.data;
};

export const get_admin_category = async (categoryId) => {
  const res = await api.get(`/categories/admin/${categoryId}`);
  return res.data;
};

export const create_admin_category = async (categoryData) => {
  const res = await api.post("/categories/admin/", categoryData);
  return res.data;
};

export const update_admin_category = async (categoryId, categoryData) => {
  const res = await api.put(`/categories/admin/${categoryId}/`, categoryData);
  return res.data;
};

export const get_admin_orders = async (params = {}) => {
  const res = await api.get("/orders/admin", { params });
  return res.data;
};

export const get_admin_order_detail = async (orderId) => {
  return await api.get(`/orders/admin/${orderId}/`);
};

export const update_admin_order_status = async (id, data) => {
  const res = await api.put(`/orders/admin/${id}/update-status/`, data);
  return res.data;
};
...
export const get_admin_user_detail = async (userId) => {
  const res = await api.get(`/users/admin/users/${userId}`);
  return res.data;
};

export const update_admin_user = async (userId, data) => {
  const res = await api.put(`/users/admin/users/${userId}/`, data);
  return res.data;
};

export const get_admin_comments = async (params = {}) => {
  const res = await api.get("/comments/admin", { params });
  return res.data;
};
